...
OSM::OSM() :
    nh_("~"),
    get_topology_node_server(nh_,"/get_topology_node", boost::bind(&OSM::get_topology_node_execute, this, _1),false),
    wm_query_ac("/wm_query", true),
    wm_query_result(),
    get_shape_server(nh_,"/get_shape", boost::bind(&OSM::get_shape_execute, this, _1),false),
    get_path_planner_server(nh_,"/get_path_plan", boost::bind(&OSM::get_path_plan_execute, this, _1),false),
    path_planner_ac("/path_planner", true),
    path_planner_result(),
    nearest_wlan_ac("/nearest_wlan", true),
    nearest_wlan_result(),
    get_nearest_wlan_server(nh_,"/get_nearest_wlan", boost::bind(&OSM::get_nearest_wlan_execute, this, _1),false),
    get_elevator_waypoints_server(nh_,"/get_elevator_waypoints", boost::bind(&OSM::get_elevator_waypoints_execute, this, _1),false)
{
}
...
void OSM::get_topology_node_execute(const ropod_ros_msgs::GetTopologyNodeGoalConstPtr& goal)
{
...
void OSM::get_shape_execute(const ropod_ros_msgs::GetShapeGoalConstPtr& goal)
{
...
void OSM::get_path_plan_execute(const ropod_ros_msgs::GetPathPlanGoalConstPtr& goal)
{
    ...
    path_planner_ac.sendGoal(req, boost::bind(&OSM::PathPlannerResultCb, this, _1, _2));
...
void OSM::get_nearest_wlan_execute(const ropod_ros_msgs::GetNearestWLANGoalConstPtr& goal)
{
    ...
    nearest_wlan_ac.sendGoal(req, boost::bind(&OSM::NearestWLANResultCb, this, _1, _2));
...
ropod_ros_msgs::PathPlan OSM::decode_path_plan(const std::vector<osm_bridge_ros_wrapper::PlannerArea> &planner_areas)
{
...
bool OSM::get_topology_node(int id, std::string type, ropod_ros_msgs::Position &position)
{
    ...
    wm_query_ac.sendGoal(req, boost::bind(&OSM::WMQueryResultCb, this, _1, _2));
...
bool OSM::get_shape(int id, std::string type, ropod_ros_msgs::Shape &shape)
{
    osm_bridge_ros_wrapper::WMQueryGoal req;
    req.id = id;
    req.type = type;
...
ropod_ros_msgs::Position OSM::compute_waiting_position(ropod_ros_msgs::Position elevator, ropod_ros_msgs::Position door,
...
double OSM::wrap_to_pi(double angle)
{
...
geometry_msgs::Quaternion OSM::compute_orientation(ropod_ros_msgs::Position elevator, ropod_ros_msgs::Position waiting_position)
{
...
void OSM::get_elevator_waypoints_execute(const ropod_ros_msgs::GetElevatorWaypointsGoalConstPtr& goal)
{
